...
var i=require('@stdlib/assert-is-collection/dist'),m=require('@stdlib/array-dtypes/dist'),o=require('@stdlib/array-dtype/dist'),u=require('@stdlib/array-base-assert-contains/dist'),s=require('@stdlib/array-base-join/dist'),h=require('@stdlib/stats-strided-mskmidrange/dist').ndarray,a=require('@stdlib/error-tools-fmtprodmsg/dist'),n=m("real_and_generic"),g="generic";function y(r,e){var t;if(!i(r))throw new TypeError(a('2qj2O',r));if(t=o(r)||g,!u(n,t))throw new TypeError(a('2qjHZ',s(n,'", "'),t));if(!i(e))throw new TypeError(a('2qj2y',e));if(t=o(e)||g,!u(n,t))throw new TypeError(a('2qjHq',s(n,'", "'),t));if(r.length!==e.length)throw new RangeError(a('2qj1E'));return h(r.length,r,1,0,e,1,0)}l.exports=y
